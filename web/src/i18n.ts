...
export const copy = {
  en: {
    ...
    level: 'Level', untitled: 'Untitled level', starter: 'Starter', simple: 'Easy', easy: 'Easy', medium: 'Medium', hard: 'Hard', expert: 'Expert', optimalPushes: 'Optimal pushes', playedMoves: 'Moves', playedPushes: 'Pushes', previousLevel: 'Previous level', nextLevel: 'Next level', ready: 'Ready', solverStatus: 'Solver status',
    ...
    undoMove: 'Undo move', moveUp: 'Move up', moveDown: 'Move down', moveLeft: 'Move left', moveRight: 'Move right', collapseLevels: 'Collapse level list', expandLevels: 'Expand level list', levelNumber: 'Level number', goToLevel: 'Go to level', previousStep: 'Previous step', nextStep: 'Next step', speed: 'Speed', solutionStep: 'Solution step', movePlayer: 'Move player', howToPlay: 'How to play',
    movementHelp: 'Move with the arrow keys, WASD, or the on-screen direction pad.', goalHelp: 'Push every crate onto a goal. Crates can be pushed but cannot be pulled.', recoveryHelp: 'Press Z or Backspace to undo one step. Press R to restart the level from its initial board.', replayHelp: 'After solving, pause the replay or inspect the solution one step at a time.',
    ...
    optimalProven: 'Shortest pushes verified', feasibleOnly: 'Solution found', timedOut: 'Timed out', unsolved: 'No solution', invalid: 'Invalid level',
    language: 'Language',
  ...
  zh: {
    ...
    level: '关卡', untitled: '未命名关卡', starter: '入门', simple: '简单', easy: '简单', medium: '中等', hard: '困难', expert: '专家', optimalPushes: '最少推动', playedMoves: '移动', playedPushes: '推动', previousLevel: '上一关', nextLevel: '下一关', ready: '就绪', solverStatus: '求解状态',
    newLevel: '新关卡', import: '导入', export: '导出', reset: '重置',
    board: '地图', tools: '工具',
    quick: '快速解', optimal: '最短解', play: '播放解法', pause: '暂停解法',
    undoMove: '回退一步', moveUp: '向上移动', moveDown: '向下移动', moveLeft: '向左移动', moveRight: '向右移动', collapseLevels: '收起关卡列表', expandLevels: '展开关卡列表', levelNumber: '关卡编号', goToLevel: '跳转关卡', previousStep: '上一步解法', nextStep: '下一步解法', speed: '倍速', solutionStep: '解法进度', movePlayer: '移动玩家', howToPlay: '玩法说明',
    movementHelp: '使用方向键、WASD 或屏幕方向键移动玩家。', goalHelp: '把所有箱子推到目标点；箱子只能推，不能拉。', recoveryHelp: '按 Z 或 Backspace 回退一步，按 R 重新开始并恢复初始地图。', replayHelp: '求解后可以暂停回放，也可以前后逐步查看解法。',
    ...
    optimalProven: '已验证最少推动', feasibleOnly: '已找到解法', timedOut: '求解超时', unsolved: '无解', invalid: '地图无效',
    language: '语言',
