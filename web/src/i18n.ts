...
export const copy = {
  en: {
    ...
    level: 'Level', untitled: 'Untitled level', starter: 'Starter', easy: 'Easy', medium: 'Medium', hard: 'Hard', optimalPushes: 'Optimal pushes', playedMoves: 'Moves', playedPushes: 'Pushes', previousLevel: 'Previous level', nextLevel: 'Next level', ready: 'Ready', solverStatus: 'Solver status',
  ...
  zh: {
    ...
    level: '关卡', untitled: '未命名关卡', starter: '入门', easy: '简单', medium: '中等', hard: '困难', optimalPushes: '最少推动', playedMoves: '移动', playedPushes: '推动', previousLevel: '上一关', nextLevel: '下一关', ready: '就绪', solverStatus: '求解状态',
