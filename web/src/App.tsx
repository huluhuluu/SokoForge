...
function GameControls({ t, onMove, onUndo, onRestart, moveDisabled, undoDisabled }: { t: Translations; onMove: (direction: string) => void; onUndo: () => void; onRestart: () => void; moveDisabled: boolean; undoDisabled: boolean }) {
  return <div className="game-controls"><button title={t.undoMove} aria-label={t.undoMove} disabled={undoDisabled} onClick={onUndo}><Undo2 size={16} /></button><button title={t.restartLevel} aria-label={t.restartLevel} onClick={onRestart}><RotateCcw size={16} /></button><button title={t.moveLeft} aria-label={t.moveLeft} disabled={moveDisabled} onClick={() => onMove('L')}><ArrowLeft size={18} /></button><button title={t.moveUp} aria-label={t.moveUp} disabled={moveDisabled} onClick={() => onMove('U')}><ArrowUp size={18} /></button><button title={t.moveDown} aria-label={t.moveDown} disabled={moveDisabled} onClick={() => onMove('D')}><ArrowDown size={18} /></button><button title={t.moveRight} aria-label={t.moveRight} disabled={moveDisabled} onClick={() => onMove('R')}><ArrowRight size={18} /></button></div>
}
